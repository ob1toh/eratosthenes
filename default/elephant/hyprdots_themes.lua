--
-- Dynamic Eratosthenes Theme Menu for Elephant/Walker
--
Name = "eratosthenesthemes"
NamePretty = "Eratosthenes Themes"
...
function GetEntries()
  local entries = {}
  local user_theme_dir = os.getenv("HOME") .. "/.config/eratosthenes/themes"
  local eratosthenes_path = os.getenv("ERATOSTHENES_PATH") or ""
  local default_theme_dir = eratosthenes_path .. "/themes"
      ...
      if theme_name and not seen_themes[theme_name] then
        ...
        if preview_path and preview_path ~= "" then
          ...
          table.insert(entries, {
            ...
            PreviewType = "file",
            Actions = {
              activate = "eratosthenes-theme-set " .. theme_name,
            },
          })
        end
      end
