--
-- Dynamic Eratosthenes Unlocks Menu for Elephant/Walker
--
-- A "Default" entry restores the eratosthenes-shipped Plymouth via
-- eratosthenes-plymouth-reset. After that, every theme that has a preview-unlock.png
-- appears as a customised unlock; picking one runs eratosthenes-plymouth-set-by-theme
-- <theme>. Both run in a floating terminal so sudo can prompt.
--
Name = "eratosthenesunlocks"
NamePretty = "Eratosthenes Unlocks"
...
function GetEntries()
  ...
  local user_themes_dir = home .. "/.config/eratosthenes/themes"
  local eratosthenes_path = os.getenv("ERATOSTHENES_PATH") or ""
  local default_themes_dir = eratosthenes_path .. "/themes"
  local default_preview = eratosthenes_path .. "/default/plymouth/preview-unlock.png"
      ...
      if theme_name and not seen_themes[theme_name] then
        ...
        if file_exists(preview_path) then
          ...
          table.insert(entries, {
            ...
            PreviewType = "file",
            Actions = {
              activate = "eratosthenes-launch-floating-terminal-with-presentation "
                .. shell_escape("eratosthenes-plymouth-set-by-theme " .. shell_escape(theme_name)),
            },
          })
        end
      end
  ...
  local default_entry = {
    ...
    Actions = {
      activate = "eratosthenes-launch-floating-terminal-with-presentation "
        .. shell_escape("eratosthenes-plymouth-reset"),
    },
  }
