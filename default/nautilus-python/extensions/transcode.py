...
class TranscodeAction(GObject.GObject, Nautilus.MenuProvider):
    def _launch_transcode(self, paths):
        wrapper = shutil.which("eratosthenes-launch-floating-terminal-with-presentation")
        binary = shutil.which("eratosthenes-transcode")
    ...
    def _make_item(self, paths):
        ...
        item = Nautilus.MenuItem(
            name="EratosthenesTranscodeNautilus::transcode",
            label=label,
    ...
    def _tools_available(self):
        return bool(
            shutil.which("eratosthenes-launch-floating-terminal-with-presentation")
            and shutil.which("eratosthenes-transcode")
        )
