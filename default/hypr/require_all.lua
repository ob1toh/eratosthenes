...
-- Used for Eratosthenes extension-style folders such as default/hypr/apps,
-- default/hypr/bindings, and ~/.local/state/eratosthenes/toggles/hypr.
-- Pass a module prefix for normal package.path modules, e.g.
--   require_all.files(paths.eratosthenes_path .. "/default/hypr/apps", "default.hypr.apps")
