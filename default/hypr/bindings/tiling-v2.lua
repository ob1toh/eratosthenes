...
o.bind("CTRL + ALT + DELETE", "Close all windows", "eratosthenes-hyprland-window-close-all")
...
o.bind("SUPER + O", "Pop window out (float & pin)", "eratosthenes-hyprland-window-pop")
o.bind("SUPER + L", "Toggle workspace layout", "eratosthenes-hyprland-workspace-layout-toggle")
...
o.bind("SUPER + code:61", "Cycle monitor scaling", "eratosthenes-hyprland-monitor-scaling-cycle")
o.bind("SUPER + ALT + code:61", "Cycle monitor scaling backwards", "eratosthenes-hyprland-monitor-scaling-cycle --reverse")
