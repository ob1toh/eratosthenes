...
local function command_from(value, description)
  ...
  if value.eratosthenes then
    return "eratosthenes-launch-" .. value.eratosthenes
  ...
  elseif value.tui then
    if value.focus then
      return "eratosthenes-launch-or-focus-tui " .. shell_quote(value.tui)
    else
      return "eratosthenes-launch-tui " .. shell_quote(value.tui)
    end
  end
...
function o.launch_webapp(url)
  return "eratosthenes-launch-webapp " .. shell_quote(url)
end

function o.launch_webapp_sole(name, url)
  return "eratosthenes-launch-or-focus-webapp " .. shell_quote(name) .. " " .. shell_quote(url)
end

function o.launch_sole(match, command)
  return "eratosthenes-launch-or-focus " .. shell_quote(match) .. " " .. shell_quote(o.launch(command))
end

function o.bind_menu(keys, description, menu, options)
  o.bind(keys, description, menu and ("eratosthenes-menu " .. menu) or "eratosthenes-menu", options)
end

function o.bind_toggle(keys, description, toggle, options)
  o.bind(keys, description, "eratosthenes-toggle-" .. toggle, options)
end
