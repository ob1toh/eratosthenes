...
cp -r $ERATOSTHENES_PATH/config/eratosthenes/* $HOME/.config/eratosthenes/

echo "Add packages for updated eratosthenes-capture-screenshot"
eratosthenes-pkg-add grim slurp

echo "Add nfs support by default to Nautilus"
eratosthenes-pkg-add gvfs-nfs
